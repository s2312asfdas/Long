...
namespace  _MEMORY_HELPER_
{
	...
	LPFN_RTLALLOCATEHEAP  __RtlAllocateHeap = NULL;
	LPFN_RTLFREEHEAP      __RtlFreeHeap = NULL;
	LPFN_NTALLOCATEVIRTUALMEMORY __NtAllocateVirtualMemory = NULL;
	LPFN_NTFREEVIRTUALMEMORY     __NtFreeVirtualMemory = NULL;
	BOOL SeInitializeMember()
	{
		...
		__RtlAllocateHeap = (LPFN_RTLALLOCATEHEAP)GetProcAddress(ModuleHandle, "RtlAllocateHeap");
		__RtlFreeHeap = (LPFN_RTLFREEHEAP)GetProcAddress(ModuleHandle, "RtlFreeHeap");
		__NtAllocateVirtualMemory = (LPFN_NTALLOCATEVIRTUALMEMORY)GetProcAddress(ModuleHandle, "NtAllocateVirtualMemory");
		__NtFreeVirtualMemory = (LPFN_NTFREEVIRTUALMEMORY)GetProcAddress(ModuleHandle, "NtFreeVirtualMemory");
		if (__RtlAllocateHeap == NULL||__RtlFreeHeap==NULL||__NtAllocateVirtualMemory==NULL||__NtFreeVirtualMemory==NULL)
		{
			return FALSE;
		}
		return TRUE;
